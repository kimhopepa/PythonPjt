...
class WindowClass(QMainWindow, form_class) :
    ...
    def literalConvert(self):
        try :
            ...
            text_bindingQuery = self.lineEdit_bindingQuery.text()
            text_bindingParameter = self.lineEdit_Parameter.text()
            ...
            #2. UI의 lineEdit에 저장
            self.lineEdit_literalQuery.setText(text_literal_query)
